...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/TYReleaseDebugger/ReleaseDebugger.bundle"
  ...
  install_resource "${PODS_ROOT}/TYUrlPredefined/TYUrlPredefined-0.2.96/Assets/resources/ty_route_config.json"
