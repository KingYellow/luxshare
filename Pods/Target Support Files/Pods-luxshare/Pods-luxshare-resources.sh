...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/TYSmartBusinessLibrary/TYSmartBusinessLibrary-3.17.5.bizbundle.3.17.0.4/Assets/resources/cell_view_arrow@2x.png"
  install_resource "${PODS_ROOT}/TYSmartBusinessLibrary/TYSmartBusinessLibrary-3.17.5.bizbundle.3.17.0.4/Assets/resources/cell_view_arrow@3x.png"
  install_resource "${PODS_ROOT}/TYSmartBusinessLibrary/TYSmartBusinessLibrary-3.17.5.bizbundle.3.17.0.4/Assets/bundles/TPViews.bundle"
  install_resource "${PODS_ROOT}/TYSmartBusinessLibrary/TYSmartBusinessLibrary-3.17.5.bizbundle.3.17.0.4/Assets/bundles/TYCropViewControllerBundle.bundle"
  install_resource "${PODS_ROOT}/TYSmartBusinessLibrary/TYSmartBusinessLibrary-3.17.5.bizbundle.3.17.0.4/Assets/bundles/TYSmartBusinessLibraryRes.bundle"
