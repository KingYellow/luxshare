...
typedef struct AQTutkCallbackStruct{
...
}AQTutkCallbackStruct;


@protocol TYTutkAudioQueuePcmPickerDelegate <NSObject>
...
@interface TYTutkAudioQueuePcmPicker: NSObject{
    AQTutkCallbackStruct aqc;
...
@property (nonatomic, weak) id<TYTutkAudioQueuePcmPickerDelegate> delegate;
