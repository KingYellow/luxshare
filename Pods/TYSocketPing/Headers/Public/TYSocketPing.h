...
@protocol TYSocketPingDelegate;

/*! Controls the IP address version used by SimplePing instances.
 */

typedef NS_ENUM(NSInteger, TYSocketPingAddressStyle) {
    TYSocketPingAddressStyleAny,          ///< Use the first IPv4 or IPv6 address found; the default.
    TYSocketPingAddressStyleICMPv4,       ///< Use the first IPv4 address found.
    TYSocketPingAddressStyleICMPv6        ///< Use the first IPv6 address found.
};
...
@interface TYSocketPing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<TYSocketPingDelegate> delegate;

/*! Controls the IP address version used by the object.
 *  \details You should set this value before starting the object.
 */

@property (nonatomic, assign, readwrite) TYSocketPingAddressStyle addressStyle;
...
@protocol TYSocketPingDelegate <NSObject>
...
- (void)ty_socketPing:(TYSocketPing *)pinger didStartWithAddress:(NSData *)address;
...
- (void)ty_socketPing:(TYSocketPing *)pinger didFailWithError:(NSError *)error;
...
- (void)ty_socketPing:(TYSocketPing *)pinger didSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber;
...
- (void)ty_socketPing:(TYSocketPing *)pinger didFailToSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber error:(NSError *)error;
...
- (void)ty_socketPing:(TYSocketPing *)pinger didReceivePingResponsePacket:(NSData *)packet timeToLive:(NSInteger)timeToLive sequenceNumber:(uint16_t)sequenceNumber timeElapsed:(NSTimeInterval)timeElapsed;
...
- (void)ty_socketPing:(TYSocketPing *)pinger didReceiveUnexpectedPacket:(NSData *)packet;
