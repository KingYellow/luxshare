...
@interface TYSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<TYSimplePingDelegate> delegate;
...
@protocol TYSimplePingDelegate <NSObject>
...
- (void)simplePing:(TYSimplePing *)pinger didStartWithAddress:(NSData *)address;
 ...
 */
- (void)simplePing:(TYSimplePing *)pinger didFailWithError:(NSError *)error;
...
- (void)simplePing:(TYSimplePing *)pinger didSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber;
 ...
 *  \param error Describes the failure.
 */
- (void)simplePing:(TYSimplePing *)pinger didFailToSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber error:(NSError *)error;
 ...
 *  \param sequenceNumber The ICMP sequence number of that packet.
 */
- (void)simplePing:(TYSimplePing *)pinger didReceivePingResponsePacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber;
 ...
 *      follows that in the ICMP message but does not include any IP-level headers.
 */
- (void)simplePing:(TYSimplePing *)pinger didReceiveUnexpectedPacket:(NSData *)packet;
