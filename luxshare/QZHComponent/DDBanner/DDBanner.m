...
@interface DDBanner()<UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
...
{
    if (!self.timerSecond) {
        self.timerSecond = 2.0;
    }
    _kvTimer = [NSTimer scheduledTimerWithTimeInterval:self.timerSecond
                                                target:self
