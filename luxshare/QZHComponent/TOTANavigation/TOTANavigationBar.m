...
@property (nonatomic,strong)TOTANaviOptions *options ;
...
@implementation TOTANavigationBar
...
- (TOTANaviOptions *)options
{
    if (nil == _options) {
        _options  = [TOTANaviOptions shareInstance];
    }
    return _options ;
}
