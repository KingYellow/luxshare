...
{
    [QZHEmptyView hiddenEmptyView:self];
...
+ (QZHEmptyView *)showEmptyInView:(UIView *)superview item:(EasyEmptyPart *(^)(void))item
{
    return [self showEmptyInView:superview item:item config:nil];
}

+ (QZHEmptyView *)showEmptyInView:(UIView *)superview item:(EasyEmptyPart *(^)(void))item config:(EasyEmptyConfig *(^)(void))config
{
               ...
               callback:(emptyViewCallback)callback
{
    ...
    QZHEmptyView *emptyView = [[QZHEmptyView alloc]initWithConfig:emptyConfig];
...
+ (void)hiddenEmptyInView:(UIView *)superView
{
    ...
    for (UIView *subview in subviewsEnum) {
        if ([subview isKindOfClass:self]) {
            QZHEmptyView *emptyView = (QZHEmptyView *)subview ;
